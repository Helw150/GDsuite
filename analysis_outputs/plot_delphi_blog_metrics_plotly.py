...
def plot_grid(fam: pd.DataFrame, stem: str, title: str, metric: str) -> None:
    fig = make_subplots(
        rows=2,
        cols=3,
...
def plot_optima(fam: pd.DataFrame, opt_models: list[str], stem: str, title: str, metric: str) -> None:
...
def plot_twitter_optima(fam: pd.DataFrame, opt_models: list[str], stem: str, title: str, metric: str) -> None:
    opt = fam[fam.model.isin(opt_models)].copy()
    fig = make_subplots(
        rows=2,
        cols=3,
